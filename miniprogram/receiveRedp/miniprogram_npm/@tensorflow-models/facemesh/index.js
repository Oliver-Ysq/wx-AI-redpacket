module.exports = (function () {
    ...
    __DEFINE__(1610694602214, function (require, module, exports) {
        ...
        var FACEMESH_GRAPHMODEL_PATH = 'https://weixinredpacket-1258344707.file.myqcloud.com/posemodel/mesh/model.json';
        ...
        function load(_a) {
            var _b = _a === void 0 ? {} : _a,
                _c = _b.maxContinuousChecks,
                maxContinuousChecks = _c === void 0 ? 5 : _c,
                _d = _b.detectionConfidence,
                detectionConfidence = _d === void 0 ? 0.9 : _d,
                _e = _b.maxFaces,
                maxFaces = _e === void 0 ? 10 : _e,
                _f = _b.iouThreshold,
                iouThreshold = _f === void 0 ? 0.3 : _f,
                _g = _b.scoreThreshold,
                scoreThreshold = _g === void 0 ? 0.75 : _g;
        ...
        function loadDetectorModel(maxFaces, iouThreshold, scoreThreshold) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/ , blazeface.load({
                        maxFaces: maxFaces,
        ...
        function loadMeshModel() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/ , tfconv.loadGraphModel(FACEMESH_GRAPHMODEL_PATH)];
                });
            });
        }
                        ...
                        switch (_b.label) {
                            ...
                            case 4:
                                ...
                                if (predictions != null && predictions.length > 0) {
                                    return [2 /*return*/ , Promise.all(predictions.map(function (prediction, i) {
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    case 0:
                                                        ...
                                                        return [4 /*yield*/ , Promise.all(tensorsToRead.map(function (d) {
                                                            return __awaiter(_this, void 0, void 0, function () {
                                                                return __generator(this, function (_a) {
        ...
        var map = {
            "./keypoints": 1610694602215,
            "./pipeline": 1610694602216,
            "./uv_coords": 1610694602219
        };
        return __REQUIRE__(map[modId], modId);
    })
    __DEFINE__(1610694602215, function (require, module, exports) {
    ...
    __DEFINE__(1610694602216, function (require, module, exports) {
                                ...
                                return [2 /*return*/ , tf.tidy(function () {
                                    return _this.regionsOfInterest.map(function (box, i) {
                                        ...
                                        if (boxLandmarksFromMeshModel) {
                                            var indexOfNose = MESH_MODEL_KEYPOINTS_LINE_OF_SYMMETRY_INDICES[0],
                                                indexOfForehead = MESH_MODEL_KEYPOINTS_LINE_OF_SYMMETRY_INDICES[1];
                                            angle = util_1.computeRotation(box.landmarks[indexOfNose], box.landmarks[indexOfForehead]);
                                        } else {
                                            var indexOfNose = BLAZEFACE_KEYPOINTS_LINE_OF_SYMMETRY_INDICES[0],
                                                indexOfForehead = BLAZEFACE_KEYPOINTS_LINE_OF_SYMMETRY_INDICES[1];
                                            angle = util_1.computeRotation(box.landmarks[indexOfNose], box.landmarks[indexOfForehead]);
                                        }
                                        ...
                                        _this.regionsOfInterest[i] = __assign({}, landmarksBox, {
    ...
    __DEFINE__(1610694602217, function (require, module, exports) {
    ...
    __DEFINE__(1610694602218, function (require, module, exports) {
    ...
    __DEFINE__(1610694602219, function (require, module, exports) {
    ...
    return __REQUIRE__(1610694602214);
})()
//# sourceMappingURL=index.js.map